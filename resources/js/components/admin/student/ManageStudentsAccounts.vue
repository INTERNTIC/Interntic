...
const { addStudent, getMajors, levels, majors, generalErrorMsg, errors } = useManageStudent();
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="floating-preview">
                            <form @submit.prevent="addStudent(studentModel)" class="row">

                                <h5 class="mb-3">Example</h5>
                                <div class="col-lg-6">
                                    <FloatingInput v-model="studentModel.first_name"
                                        :errorText="shared.getErrorText(errors, 'first_name')"
                                        :showError="errors.hasOwnProperty('first_name')" label="First Name"
                                        placeholder="Enter First Name" inputType="text" />
                                </div>
                                <div class="col-lg-6">
                                    <FloatingInput v-model="studentModel.last_name"
                                        :errorText="shared.getErrorText(errors, 'last_name')"
                                        :showError="errors.hasOwnProperty('last_name')" label="Last Name"
                                        placeholder="Enter Last Name" inputType="text" />
                                </div>
                                <div class="col-lg-6">
                                    <FloatingInput v-model="studentModel.email"
                                        :errorText="shared.getErrorText(errors, 'email')"
                                        :showError="errors.hasOwnProperty('email')" label="Email Address"
                                        placeholder="Enter Email" inputType="email" />
                                </div>
                                <div class="col-lg-6">
                                    <FloatingInput v-model="studentModel.phone_number"
                                        :errorText="shared.getErrorText(errors, 'phone_number')"
                                        :showError="errors.hasOwnProperty('phone_number')" label="Phone Number"
                                ...
                                <div class="col-lg-6">
                                    <FloatingInput v-model="studentModel.student_card_number"
                                        ...
                                        :showError="errors.hasOwnProperty('.student_card_number')"
                                        label="Student Card Number" placeholder="Enter Student Card Number"
                                        inputType="text" />
                                </div>
                                <div class="col-lg-6">
                                    <FloatingInput v-model="studentModel.social_security_num"
                                        :errorText="shared.getErrorText(errors, 'social_security_num')"
                                        :showError="errors.hasOwnProperty('social_security_num')"
                                        label="Social Security Number" placeholder="Enter Social Security Number"
                                        inputType="text" />
                                </div>
                                <div class="col-lg-6 mb-3">
                                    <SelectInput propertyOfValue="id" property-of-show="name"
                                        placeholder="Select Student Level" :floatingTheme="true"
                                        v-model="studentModel.level_id" :errorText="shared.getErrorText(errors, 'major_id')"
                                        :showError="errors.hasOwnProperty('major_id')" label="Select Student Level"
                                        :options="levels" />
                                </div>
                               
                                <div class="col-lg-6 mb-3">
                                    <SelectInput propertyOfValue="id" property-of-show="name"
                                        placeholder="Select Student Major" :floatingTheme="true"
                                        v-model="studentModel.major_id" :errorText="shared.getErrorText(errors, 'major_id')"
                                        :showError="errors.hasOwnProperty('major_id')" label="Select Student Major"
                                        :options="majors" />
                                </div>
                                <div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">
                        DataTables has most features enabled by default, so all you need to do to use it with own
